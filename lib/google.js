...
Google.prototype.makeApiRequest = function (options, cb) {
	...
	options.params.token = options.token;

	request({
		method: options.method || 'GET',
		headers: { Authorization: 'Bearer ' + options.token },
		url: url.resolve((options.base ? options.base : this.providerInfo.apiUrl) + options.slug, url.format({ query: options.params }))
	}, this.createErrorHandler(cb));
};

/*
	refreshToken: {optional: false}
